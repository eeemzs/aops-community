...
export const docmanErrorsResources: BmResourceInline<never, ILabelsDocmanServerErrorsTags> = {
  tags: {
    error__validation: {
...
export type ILabelsDocmanServerErrorsTranslationKeys = I18nBmValidKeys<
  never,
  ValidationResourceType,
  ILabelsDocmanServerErrorsTags
>
