...
export interface ILabelsSysServerErrorsTags {
...
export const sysErrorsResources: BmResourceInline<never, ILabelsSysServerErrorsTags> = {
  tags: {
    error__validation: {
...
export type ILabelsSysServerErrorsTranslationKeys = I18nBmValidKeys<
  never,
  ValidationResourceType,
  ILabelsSysServerErrorsTags
>
