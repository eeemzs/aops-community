...
export class KanbanBoardDrizzleSqliteRepo
  extends DraBaseSqlite<IbmKanbanBoard, IdbKanbanBoardDrizzleSqlite, typeof kanbanBoardTableSqlite>
  implements IRepositoryPortKanbanBoard
{
