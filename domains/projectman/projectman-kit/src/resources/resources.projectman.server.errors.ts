...
export interface ILabelsProjectmanServerErrorsTags {
...
export const projectmanErrorsResources: BmResourceInline<never, ILabelsProjectmanServerErrorsTags> = {
  tags: {
    error__validation: {
...
export type ILabelsProjectmanServerErrorsTranslationKeys = I18nBmValidKeys<
  never,
  ValidationResourceType,
  ILabelsProjectmanServerErrorsTags
>
